...
class BBox:  # numpydoc ignore=PR01
    ...
    def mesh(self) -> pv.PolyData:
        ...
        Examples
        --------
        Add a ``C32`` bounding-box around North Africa and Western Europe.
        ...
        ... )
        >>> bbox = BBox(lons=[-20, 20, 20, -20], lats=[10, 10, 50, 50], c=32)
    ...
    def boundary(
        ...
        around the ``0`` meridian. The geodesic bounding-box is generated by
        ...
        >>> bbox = BBox(lons=[-20, 20, 20, -20], lats=[-20, -20, 50, 50], c=32)
